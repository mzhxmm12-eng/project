...
def building_floor_area_cal(bd: gpd.GeoDataFrame, block: gpd.GeoDataFrame, bd_type: str = 'building', height_field='height', height_per_floor=3) -> gpd.GeoDataFrame:
    ...
    # convert height field to numeric, coerce errors to NaN
    bd[height_field] = pd.to_numeric(bd[height_field], errors='coerce').fillna(0)
    ...
    # Drop geometry before groupby sum to avoid TypeError
